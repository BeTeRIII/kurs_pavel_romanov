...
def get_last_five_succsessful_operation(sort_list: list) -> list:
    succsessful_operation = [op for op in sort_list if op["state"] == "EXECUTED"]
    last_five_succsessful_operation = succsessful_operation[:5]
    return last_five_succsessful_operation
